...
def main():
    ...
    axs[1].plot(np.arange(1, nbatches+1), test_accuracy)
    axs[2].plot(np.arange(1, nbatches+1), cond_hidden)
    axs[3].plot(np.arange(1, nbatches+1), mutual_hidden)
    axs[4].plot(np.arange(1, nbatches+1), cond_output)
    axs[5].plot(np.arange(1, nbatches+1), mutual_output)
    plt.show()
